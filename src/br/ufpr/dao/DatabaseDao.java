...
public class DatabaseDao extends GenericDao {
	...
	public void cleanDataBase() throws SQLException {
		...
		sqls[11] = "DELETE FROM t002_table";
		sqls[12] = "DELETE FROM t013_datatype_property";
		sqls[13] = "DELETE FROM t016_ontology";
		sqls[14] = "DELETE FROM t001_database";
		sqls[15] = "DELETE FROM t007_check_subject";
		sqls[16] = "DELETE FROM t018_datatype_onto";
		sqls[17] = "DELETE FROM t005_datatype_db";
