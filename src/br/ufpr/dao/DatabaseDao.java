...
public class DatabaseDao extends GenericDao {
	...
	public void cleanDataBase() throws SQLException {
		...
		sqls[8] = "DELETE FROM t022_object_property_domain_range";
		sqls[9] = "DELETE FROM t003_column";
		sqls[10] = "DELETE FROM t010_table_db_domain";
		sqls[11] = "DELETE FROM t008_database_domain";
